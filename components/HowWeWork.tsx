    ...
    <section className="relative overflow-hidden border-t border-white/5 bg-[#020202] py-14 md:py-32" aria-labelledby="how-we-work-title">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden rounded-3xl md:rounded-[3rem]">
        <Beams
          ...
          rotation={30}
        />
        {/* Dark overlay to ensure contrast and maintain dark theme */}
        <div className="absolute inset-0 bg-[#020202]/75 pointer-events-none"></div>
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-12">
        <div className="mb-16 md:mb-24 relative z-10">
          <p className="mb-3 text-xs font-semibold uppercase tracking-[0.3em] text-gray-400 md:text-sm drop-shadow-md">How We Work</p>
          <h2 id="how-we-work-title" className="text-3xl font-medium tracking-tight text-white md:text-5xl drop-shadow-xl [text-shadow:0_2px_10px_rgba(0,0,0,0.8)]">
            Enterprise Predictability
          </h2>
          <p className="mt-6 max-w-xl text-sm text-gray-300 md:text-base drop-shadow-md font-medium">
