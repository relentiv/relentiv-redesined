      ...
      <main className="flex-1 relative flex flex-col w-full min-h-screen">
        ...
        <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 md:px-12 py-32 flex flex-col gap-40 pointer-events-none">
          ...
          >
            ...
            >
              Relentiv is led by Utkarsh, founder and CEO. We are a
              Bengaluru-based digital product studio blurring the line between
              technology and art. Uncompromising quality is our baseline.
            </motion.p>
          </motion.section>
            ...
            <ul className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <motion.li
                  key={i}
                  variants={fadeInUp}
                  className="p-10 rounded-[2rem] bg-white/[0.02] backdrop-blur-xl border border-white/10 hover:bg-white/[0.04] transition-colors duration-500 hover:border-white/20 list-none"
                >
                  <h3 className="text-2xl font-bold mb-4" style={{ fontFamily: "var(--font-doto)" }}>
                    {val.title}
                  </h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                >
                  ...
                  <h3 className="text-xl font-bold text-white relative z-10 mb-2" style={{ fontFamily: "var(--font-doto)" }}>
                    {skill.name}
                  </h3>
