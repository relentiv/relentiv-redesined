...
export function Hero() {
  ...
  return (
    <div className="w-full min-h-[calc(100dvh-100px)] flex items-center justify-center overflow-hidden pb-12 pt-8 md:pt-12 relative">
      <div className="container px-[24px] md:px-[48px] max-w-[1600px] flex flex-col lg:flex-row items-center justify-between relative gap-12 lg:gap-8">
        ...
        <div className="w-full lg:w-[55%] flex flex-col z-10 relative">
          <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-semibold tracking-tighter leading-[1.1] md:leading-[1.05] max-w-4xl">
          ...
          <p className="mt-6 md:mt-8 text-base md:text-xl text-neutral-400 max-w-2xl leading-relaxed tracking-wide">
          ...
          <div className="mt-8 md:mt-12 flex items-center gap-4">
            ...
            <button
              ...
              className="px-6 md:px-8 py-3.5 md:py-3 rounded-full border-2 border-dotted border-white/40 text-white/90 font-mono tracking-[0.2em] text-sm uppercase hover:bg-white hover:text-black hover:border-solid hover:border-white transition-all duration-300 ease-in-out"
            >
              Start Project
            </button>
          </div>
